		...
		var modal = function () {
			...
			if (modalUI === 'bootstrap') {
				...
				if (options.timer === true) {
				  footer = $('<div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Stay Logged In (<span id="countdowntimer">' + seconds + '</span>)</button></div>');
					countDown(seconds);
				} else {
					footer = $('<div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal">Stay Logged In</button></div>');
				}
				
				logoutBtn = $('<button type="button" class="btn btn-danger" id="logoff">Log Off</button>');
